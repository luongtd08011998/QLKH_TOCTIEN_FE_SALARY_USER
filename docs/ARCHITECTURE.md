...
**Repository này là SPA (React).** Stack Vite/React, cấu trúc thư mục `src/`, routing và luồng bootstrap: xem **[FRONTEND.md](./FRONTEND.md)**. Các mục bên dưới mô tả **backend** mà client gọi (Spring Boot, JWT, RBAC).
